  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'body-md-custom': ['16px', { lineHeight: '1.6', letterSpacing: '0em', fontWeight: '400' }],
      ...
      keyframes: {
        ...
        'glow-pulse': {
          '0%, 100%': { boxShadow: '0 0 15px rgba(76, 215, 246, 0.4)' },
          '50%': { boxShadow: '0 0 30px rgba(76, 215, 246, 0.8)' },
        },
        shimmer: {
