...
export default function ChangePasswordPage() {
  ...
  const submit = async () => {
    ...
    setLoading(true);
    try {
      const res = await profileService.changePassword({ current_password: currentPassword, new_password: newPassword });
    ...
    <div className="space-y-5 pb-6 max-w-lg mx-auto animate-blur-fade-up">
      ...
      <div className="glass-panel rounded-2xl p-6 space-y-4">
        <div className="flex items-center gap-2 text-on-surface font-medium">
          <span className="material-symbols-outlined text-primary">key</span> Update your password
        </div>
